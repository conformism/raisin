...
public:
	...
	[[nodiscard]] auto insert(Uuid uuid, T* value)
	  -> result::Result<T*, result::Failures::INVALID_UUID, result::Failures::NO_RESOURCES, result::Failures::ALREADY_INSIDE>
	{
		constexpr auto success = result::
			success<T*, result::Failures::INVALID_UUID, result::Failures::NO_RESOURCES, result::Failures::ALREADY_INSIDE>;
		constexpr auto failure_no_resource = result::failure<
			T*,
			result::Failures::NO_RESOURCES,
			result::Failures::INVALID_UUID,
			result::Failures::NO_RESOURCES,
			result::Failures::ALREADY_INSIDE>;
