...
private:
    ...
    explicit BasicDomainResult(ValueType value) : _value(value), _succeed(true) {
        _check_type();
    };
...
public:
    ...
    // }
    [[nodiscard]] static auto create(ErrorType const error) -> BasicDomainResult<Vt, ErrorType> {
